...
public class ButtonsOneClickListActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.add_menu:
                ...
                Intent i = new Intent(ButtonsOneClickListActivity.this, BoardFormActivity.class);
                i.putExtras(pkg);
                startActivity(i);
                break;
